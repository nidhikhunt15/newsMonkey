...
const fetchMoreData = async() => {
  const url=`https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=${props.apiKey}&page=${page+1}&pageSize=${props.pageSize}`;
    ...
    return (
      <>
        <h1 > <marquee behaviour="scroll" scrollamount="12" direction="left" style={{marginTop:'80px'}} >NewsMonkey - Top Headlines from {capitalizeFirstLetter(props.category)}</marquee></h1>
        {loading && <Spinner/>} 
